...
import {_getAllGaugesFormatted, _getPoolFilters} from '../external-api.js';
import {
    _cutZeros,
    _ensureAllowance,
    _get_price_impact,
...
export class PoolTemplate extends CorePool {
    ...
    estimateGas: {
        ...
        depositWrapped: (amounts: (number | string)[], slippage?: number) => Promise<number | number[]>,
        ...
        depositAndStake: (amounts: (number | string)[], slippage?: number) => Promise<number>,
        depositAndStakeWrappedApprove: (amounts: (number | string)[]) => Promise<number | number[]>,
        depositAndStakeWrapped: (amounts: (number | string)[], slippage?: number) => Promise<number | number[]>,
        withdrawApprove: (lpTokenAmount: number | string) => Promise<number | number[]>,
        withdraw: (lpTokenAmount: number | string, slippage?: number) => Promise<number | number[]>,
        withdrawWrapped: (lpTokenAmount: number | string, slippage?: number) => Promise<number | number[]>,
        withdrawImbalanceApprove: (amounts: (number | string)[]) => Promise<number | number[]>,
        withdrawImbalance: (amounts: (number | string)[], slippage?: number) => Promise<number | number[]>,
        withdrawImbalanceWrapped: (amounts: (number | string)[], slippage?: number) => Promise<number | number[]>,
        withdrawOneCoinApprove: (lpTokenAmount: number | string) => Promise<number | number[]>,
        withdrawOneCoin: (lpTokenAmount: number | string, coin: string | number, slippage?: number) => Promise<number | number[]>,
        withdrawOneCoinWrapped: (lpTokenAmount: number | string, coin: string | number, slippage?: number) => Promise<number | number[]>,
